...
// recoloured to Protocol's cobalt/violet on near-black. Zero dependencies: one
// WebGL canvas that fills its parent. Drop it behind content with
...
const UNIFORMS = {
  // Protocol palette: near-black → cobalt → violet → light cobalt.
  colors: [[0.0392,0.0392,0.0431],[0.231,0.510,0.965],[0.486,0.227,0.929],[0.576,0.706,1.0],[0.576,0.706,1.0],[0.576,0.706,1.0],[0.576,0.706,1.0],[0.576,0.706,1.0]] as [number, number, number][],
  colorCount: 4,
  scale: 1.600,
  intensity: 0.500,
  paramA: 0.500,
